...
$jenis = 'cetak'; // Ganti ke 'cetak' untuk halaman koleksi fisik
...
<head>
    ...
    <title>KOLEKSI FISIK - DEXENRY</title>
    ...
    <div class="book-list">
        <?php if (mysqli_num_rows($result) > 0): ?>
            <?php while ($row = mysqli_fetch_assoc($result)): ?>
                <div class="book-item">
                    <a href="<?php echo $jenis == 'cetak' ? 'detail_buku_cetak.php' : 'detail_buku_digital.php'; ?>?id_buku=<?php echo $row['id_buku']; ?>">
                        <img src="<?php echo $jenis == 'cetak' ? 'uploads' : 'uploads_digital'; ?>/<?php echo $row['cover']; ?>" alt="<?php echo $row['judul']; ?>">
