...
// Ambil data buku cetak berdasarkan ID
if (isset($_GET['id_buku'])) {
    $id_buku = (int) $_GET['id_buku'];
    $sql = "SELECT * FROM buku WHERE id_buku = $id_buku AND jenis = 'cetak'";
    ...
    if (!$row) {
        die("Data buku tidak ditemukan atau bukan buku cetak.");
    }
} else {
...
<section class="content">
    <div class="container">
        ...
        <div class="book-detail">
            ...
            <p><strong>Jumlah Buku Tersedia:</strong> <?php echo $row['tersedia']; ?></p>
            <p><strong>Deskripsi:</strong> <?php echo nl2br(htmlspecialchars($row['deskripsi_buku'])); ?></p>

            <?php if (!empty($_SESSION['signIn'])): ?>
                <form action="pinjam_cetak.php" method="post">
