...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO buku (judul, penulis, penerbit, tahun_terbit, cover, jenis, jumlah_halaman, deskripsi_buku, kategori) 
            VALUES ('$judul', '$penulis', '$penerbit', '$tahun_terbit', '$cover', 'cetak', '$jumlah_halaman', '$deskripsi_buku', '$kategori')";
...
<section class="content">
    <div class="container">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <textarea name="deskripsi_buku" id="deskripsi_buku" rows="4" required></textarea>
